...
################################################################
# This is a generated script based on design: design_cmac
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: cmac_usplus_0_init_clkwiz, and set properties
  set cmac_usplus_0_init_clkwiz [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 cmac_usplus_0_init_clkwiz ]
  set_property -dict [list \
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins cmac_usplus_0/s_axi]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins ddr4_0/C0_DDR4_S_AXI_CTRL] [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI]
  ...
  connect_bd_intf_net -intf_net xdma_0_M_AXI [get_bd_intf_pins axi_smc/S02_AXI] [get_bd_intf_pins xdma_0/M_AXI]
  ...
  connect_bd_net -net cmac_usplus_0_init_clkwiz_clk_out1 [get_bd_pins cmac_usplus_0/init_clk] [get_bd_pins cmac_usplus_0_init_clkwiz/clk_out1]
  connect_bd_net -net cmac_usplus_0_init_clkwiz_clk_out2 [get_bd_pins cmac_usplus_0/drp_clk] [get_bd_pins cmac_usplus_0_init_clkwiz/clk_out2]
  connect_bd_net -net cmac_usplus_0_init_clkwiz_locked [get_bd_pins cmac_usplus_0_init_clkwiz/locked] [get_bd_pins util_vector_logic/Op1]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_smc/aclk] [get_bd_pins cmac_usplus_0/s_axi_aclk] [get_bd_pins cmac_usplus_0_init_clkwiz/clk_in1] [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins rst_ddr4_0_300M/slowest_sync_clk]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk_sync_rst [get_bd_pins cmac_usplus_0/s_axi_sreset] [get_bd_pins cmac_usplus_0_init_clkwiz/reset] [get_bd_pins ddr4_0/c0_ddr4_ui_clk_sync_rst] [get_bd_pins rst_ddr4_0_100M/ext_reset_in] [get_bd_pins rst_ddr4_0_300M/ext_reset_in]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_ddr4_0_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_smc/aclk1] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins ddr4_0/addn_ui_clkout1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_ddr4_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ddr4_0_100M_peripheral_aresetn [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ddr4_0_100M/peripheral_aresetn]
  connect_bd_net -net rst_ddr4_0_300M_peripheral_aresetn [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins rst_ddr4_0_300M/peripheral_aresetn]
  ...
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins axi_smc/aclk2] [get_bd_pins xdma_0/axi_aclk]
  ...
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs cmac_usplus_0/s_axi/Reg] -force
  ...
  assign_bd_address -offset 0x41300000 -range 0x00100000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP_CTRL/C0_REG] -force
  ...
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs cmac_usplus_0/s_axi/Reg] -force
  ...
  assign_bd_address -offset 0x41300000 -range 0x00100000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP_CTRL/C0_REG] -force
  ...
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI] [get_bd_addr_segs cmac_usplus_0/s_axi/Reg] -force
